...
from UNet.model import generate_samples, calc_loss
...
def train_model(u_net, dataset, config, model_name, log=False, save_model=False):
    ...
    save_dir = os.path.join("UNet/results", model_name)  # Create the full directory path
    ...
    for i_epoch in range(config["epochs"]):
        ...
        torch.save(u_net.state_dict(), f"UNet/models/{model_name}ckpt.pt")
