...
from UNetCFG.model import UNet
from UNetCFG.trainer import train_model
import random
...
save_model = False
model_name = "CFG"+name+modelNameTest # File that the model is saved as. Only relevant if save_model = True
...
# Initialize model
model = UNet(in_channels=channels, dim = config["image_shape"][1], out_channels=channels, num_classes = 10)
